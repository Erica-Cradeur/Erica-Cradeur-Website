...
import WordWizardryImage from './WordWizardryImage.js';
        ...
        <div id="projectsList" className="projectsList">
          <div className="project">
            ...
            <div className="projectDescription">
              ...
              <span className="projectAbout">
                WordWizardry is a powerful and intuitive flashcard app designed to enhance the language learning experience. This user-friendly app allows you to study flashcards effortlessly with custom flashcard sets, interactive learning, randomized flashcards, engaging visuals, list and flashcard views, and premade sets!
              </span><br />
              <a href="https://erica-cradeur.github.io/WordWizardry/"><img className="linkIcon" src={process.env.PUBLIC_URL + '/arrowUp.svg'} alt="ArrowUp" /></a>
              <a href="https://github.com/Erica-Cradeur/WordWizardry"><img className="linkIcon" src={process.env.PUBLIC_URL + '/github.svg'} alt="GitHub" /></a>
            </div>
          </div>
        </div>
